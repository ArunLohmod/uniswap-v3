...
contract SwapExamples {
    ...
    IWETH public wethToken = IWETH(WETH9);
    ...
    function swapExactOutputSingle(
        ...
        wethToken.transferFrom(msg.sender, address(this), amountInMaximum);
    ...
    function swapExactInputMultihop(
        ...
        console.log("kjhffuyb");

        // The parameter path is encoded as (tokenIn, fee, tokenIn/tokenOut, fee, tokenOut)
